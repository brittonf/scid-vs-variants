...
Toga II 1.3.1 (previously know as 1.3beta1) based on Fruit 2.1 by Fabien Letouzey.
...
Released with permission from Thomas Gaksch following the end of development by Thomas.
 ...
 - Compiles by Denis Mendoza - thank you!
...
Toga II 1.3.1 based on Fruit is a UCI-only chess engine.  This distribution comes up only with
...
- this version was previously know as 1.3beta1.

For Blitz play Toga Extended History Pruning should be turned on and the History Threshold adjusted to 75
